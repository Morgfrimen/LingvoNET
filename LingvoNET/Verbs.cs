...
public static class Verbs
{
    ...
    private static VerbRaw ParseVerb(string line)
    {
        var parts = line.Split('\t');
        ...
        {
            case "нсв":
                res.Aspect = VerbAspect.Imperfect;
                break;
            case "св":
                res.Aspect = VerbAspect.Perfect;
                break;
            case "св-нсв":
                res.Aspect = VerbAspect.PerfectImperfect;
                break;
        }
        ...
        switch (Aspect)
        {
            ...
            case VerbAspect.PerfectImperfect:
                if ((Transition == VerbTransition.Transitive || voice == Voice.Active) &&
                    Verbs.ToBe is not null) //TODO: Error - ToBe is null
